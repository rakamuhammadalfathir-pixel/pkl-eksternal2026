...
>
  ...
  <body>
                          ...
                          <table class="table table-bordered">
                            ...
                            <tbody>
                              ...
                              <tr>
                                  ...
                                  <td class="text-center">{{ $item->tgl_kembali_aktual }}</td>
                                  <td class="text-center">
                                      @if($item->denda > 0)
    ...
    // Fungsi untuk delete satuan agar tidak bentrok dengan form bulk
    function deleteSingle(id) {
        if (confirm('Apakah Anda yakin ingin menghapus data ini?')) {
            const form = document.getElementById('singleDeleteForm');
            form.action = `/admin/pengembalian/${id}`; // Sesuaikan dengan route destroy Anda
            form.submit();
        }
    }
    </script>
