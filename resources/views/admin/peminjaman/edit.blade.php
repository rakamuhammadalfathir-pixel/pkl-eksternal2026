                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" class="form-control" placeholder="kode transaksi" name="kode_transaksi" value="{{ $peminjaman->kode_transaksi }}"/>
                            </div>
                          </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="date" class="form-control" placeholder="Tanggal Pinjam" name="tgl_pinjam" value="{{ $peminjaman->tgl_pinjam }}"/>
                            </div>
                          </div>
                        </div>
                        <div class="row mb-3">
