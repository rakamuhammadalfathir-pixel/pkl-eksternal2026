                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" name="nama_rak" class="form-control" placeholder="Masukkan Nama Rak"/>
                            </div>
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <textarea type="text" name="lokasi" class="form-control" placeholder="Masukkan Lokasi"></textarea>
                            </div>
                          </div>
                        </div>
