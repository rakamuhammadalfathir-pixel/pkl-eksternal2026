        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="mb-4">
                  <a href="{{ route('peminjaman_detail.create') }}" class="btn btn-primary">
                  ...
                  <div class="table text-nowrap">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                            <td>{{ $no++ }}</td>
                            <td>{{ $item->peminjaman->kode_transaksi }}</td>
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('peminjaman_detail.show', $item->id) }}"
                                  ><i class="bx bx-show me-1"></i> Show</a>
                                <a class="dropdown-item" href="{{ route('peminjaman_detail.edit', $item->id) }}"
                                  ><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                <form action="{{ route('peminjaman_detail.destroy', $item->id) }}" method="POST" style="display: inline;">
                                  @csrf
                                  @method('DELETE')
