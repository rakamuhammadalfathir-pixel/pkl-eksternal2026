        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Buat akun Anda dan nikmati kemudahan akses koleksi buku digital!</p>

              <form id="formAuthentication" class="mb-3" action="{{ route('register') }}" method="POST" >
                @csrf
                <div class="mb-3">
                  <label for="username" class="form-label">Nama Pengguna (Username)</label>
                  <input type="text" class="form-control" id="username" name="name" placeholder="Masukkan nama pengguna Anda" autocomplete="username" autofocus/>
                </div>
                <div class="mb-3">
